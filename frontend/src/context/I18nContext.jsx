...
const TRANSLATIONS = {
  en: {
    ...
    booking_pay:'Proceed to Payment', booking_seats:'seats',
    booking_booked:'Occupied', booking_available:'Available',
    ...
    payment_instruction:'Open Kaspi app → Scan QR → Pay the exact amount',
    ...
    payment_failed:'✗ Payment not confirmed. Try again or contact us.',
    ...
    contact_address_label:'Address', contact_phone:'Phone / WhatsApp',
    contact_hours:'Hours', contact_hours_val:'Mon–Sun: 08:00 – 22:00',
  ...
  ru: {
    ...
    booking_pay:'Перейти к оплате', booking_seats:'мест',
    booking_booked:'Занят', booking_available:'Свободен',
    ...
    payment_instruction:'Откройте Kaspi → Сканируйте QR → Оплатите точную сумму',
    ...
    payment_failed:'✗ Оплата не подтверждена. Попробуйте снова или свяжитесь с нами.',
    ...
    contact_address_label:'Адрес', contact_phone:'Телефон / WhatsApp',
    contact_hours:'Режим работы', contact_hours_val:'Пн–Вс: 08:00 – 22:00',
  ...
  kz: {
    ...
    booking_pay:'Төлемге өту', booking_seats:'орын',
    booking_booked:'Бос емес', booking_available:'Бос',
    ...
    payment_instruction:'Kaspi ашыңыз → QR сканерлеңіз → Дәл соманы төлеңіз',
    ...
    payment_failed:'✗ Төлем расталмады. Қайталап көріңіз.',
    ...
    contact_address_label:'Мекенжай', contact_phone:'Телефон / WhatsApp',
    contact_hours:'Жұмыс уақыты', contact_hours_val:'Дс–Жс: 08:00 – 22:00',
...
export function I18nProvider({ children }) {
  const [lang, setLangState] = useState(() => localStorage.getItem('coffesino_lang') || 'ru')

  const setLang = useCallback((l) => {
    setLangState(l)
    localStorage.setItem('coffesino_lang', l)
  }, [])
